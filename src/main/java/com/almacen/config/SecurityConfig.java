...
import com.almacen.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(@Lazy UsuarioService usuarioService, @Lazy JwtAuthenticationFilter jwtAuthenticationFilter) {
